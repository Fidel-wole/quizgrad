        ...
        <main>
            ...
            <div class="result-summary">
                ...
                <div class="results grid-flow" data-spacing="large">
                    ...
                    <p class="result-score"><span>{{$score}} %</span> of {{$quizCount}} questions</p>
                    ...
                    <div class="grid-flow">
                        <div class="summary-item" data-item-type="accent-1">
                            <div class="flex-group">
                                ...
                                <h3 class="summary-item-title">Correct Answers</h3>
                            </div>
                            <p class="summary-score"><span>{{$Correctscore}}</span> / {{$quizCount}}</p>
                        </div>
                        <div class="summary-item" data-item-type="accent-2">
                            <div class="flex-group">
                                ...
                                <h3 class="summary-item-title">Wrong Answers</h3>
                            </div>
                            <p class="summary-score"><span>{{$wrongAnswers}}</span> / {{$quizCount}}</p>
                        </div>
                        <div class="summary-item" data-item-type="accent-3">
                            <div class="flex-group">
                                ...
                                <h3 class="summary-item-title">Time Used</h3>
                            </div>
                        ...
                        <div class="summary-item" data-item-type="accent-4">
                            <div class="flex-group">
                                ...
                                <h3 class="summary-item-title">Time Remaining</h3>
                            </div>
